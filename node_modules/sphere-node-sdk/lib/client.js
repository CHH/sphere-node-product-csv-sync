...
SphereClient = (function() {
  ...
  function SphereClient(options) {
     ...
     * @type {Rest}
     */
    this._rest = options.rest || new Rest(options);
    ...
    this.project = new ProjectService(_serviceOptions);
