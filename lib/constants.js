...
exports.BASE_HEADERS = [constants.HEADER_PRODUCT_TYPE, constants.HEADER_VARIANT_ID];

exports.BASE_LOCALIZED_HEADERS = [constants.HEADER_NAME, constants.HEADER_DESCRIPTION, constants.HEADER_SLUG, constants.HEADER_META_TITLE, constants.HEADER_META_DESCRIPTION, constants.HEADER_META_KEYWORDS];

exports.SPECIAL_HEADERS = [constants.HEADER_ID, constants.HEADER_SKU, constants.HEADER_PRICES, constants.HEADER_TAX, constants.HEADER_CATEGORIES, constants.HEADER_IMAGES];
